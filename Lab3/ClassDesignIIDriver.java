...
private static void customMathDriver() {
    ...
    System.out.println("And the larger of the two is " + CustomMath.max(10.34,
    10.31));
...
// Passing a primitive: Copy of value is passed
// Passing an object: Reference to the object is passed

// When a primitive is passed to a method, does the scope of that primitive change (i.e., grow to include the called method)?
// No, the scope does not change; only a copy is passed

// What about when an object is passed to a method?
// The reference to the object is passed, scope includes the method

// How then would you describe the scope of an object that has been passed to a method?
// Scope includes both the original and the called method, changes in the method affect the original object
